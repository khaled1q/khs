...
local bank_users = redis:smembers(bot_id.."almtzog"..msg_chat_id)
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = redis:get(bot_id.."mznom"..msg_chat_id..v) 
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
for k,v in pairs(mony_list) do
if num <= 10 then
local zwga_id = redis:get(bot_id..msg_chat_id..v[2].."rgalll2:")
...
return bot.sendText(msg.chat_id,msg.id,top_mony,[[
...
return bot.sendText(msg.chat_id,msg.id, "• غبي تبي تتزوج نفسك!\n","md",true)
end
if tonumber(Message_Reply.sender.user_id) == tonumber(bot_id) then
return bot.sendText(msg.chat_id,msg.id, "• غبي تبي تتزوج بوت!\n","md",true)
end
if redis:get(bot_id..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = redis:get(bot_id..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = redis:get(bot_id..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local albnt = bot.getUser(zoog2)
fne = redis:get(bot_id..':toob:Name:'..zoog2)
albnt = "["..fne.."](tg://user?id="..zoog2..") "
return bot.sendText(msg_chat_id,msg_id,"• الحق ي : "..albnt.." زوجك يبي يتزوج ","md")
end
if redis:get(bot_id..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = redis:get(bot_id..msg_chat_id..msg.sender.user_id.."bnttt2:") 
local zoog2 = redis:get(bot_id..msg_chat_id..zwga_id.."rgalll2:") 
local id_rgal = bot.getUser(zwga_id)
fne = redis:get(bot_id..':toob:Name:'..zwga_id)
alzog = "["..fne.."](tg://user?id="..zwga_id..") "
return bot.sendText(msg_chat_id,msg_id,"• الحقي ي : "..alzog.." زوجتك تبي تتزوج ","md")
end
ballancee = redis:get(bot_id.."nool:flotysb"..msg.sender.user_id) or 0
if tonumber(coniss) < 1000 then
return bot.sendText(msg.chat_id,msg.id, "• المهر لازم اكثر من 1000 ريال 💸\n","md",true)
end
if tonumber(ballancee) < tonumber(coniss) then
return bot.sendText(msg.chat_id,msg.id, "• فلوسك ماتكفي للمهر\n","md",true)
end
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if redis:get(bot_id..msg_chat_id..Message_Reply.sender.user_id.."rgalll2:") or redis:get(bot_id..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:") then
...
local zwga_id = redis:get(bot_id..msg_chat_id..msg.sender.user_id.."bnttt2:") 
redis:set(bot_id..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:", msg.sender.user_id)
redis:set(bot_id..msg_chat_id..msg.sender.user_id.."rgalll2:", Message_Reply.sender.user_id)
redis:set(bot_id..msg_chat_id..Message_Reply.sender.user_id.."mhrrr2:", UserNameyy)
redis:set(bot_id..msg_chat_id..msg.sender.user_id.."mhrrr2:", UserNameyy)
...
redis:incrby(bot_id.."mznom"..msg_chat_id..msg.sender.user_id , UserNameyy)
redis:sadd(bot_id.."almtzog"..msg_chat_id,msg.sender.user_id)
return bot.sendText(msg_chat_id,msg_id,"• مبرووك تم زواجكم\n• الزوج :"..alzog.."\n• الزوجه :"..albnt.."\n• المهر : "..UserNameyy.." بعد خصم 15% \n• لعرض عقدكم اكتبو زواجي","md")
end
if text == "زوجي" then
if redis:get(bot_id..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = redis:get(bot_id..msg_chat_id..msg.sender.user_id.."bnttt2:") 
...
fne = redis:get(bot_id..':toob:Name:'..zwga_id)
alzog = "["..fne.."](tg://user?id="..zwga_id..") "
return bot.sendText(msg_chat_id,msg_id,"• ي : "..alzog.." زوجتك تبيك ","md")
else
return bot.sendText(msg_chat_id,msg_id,"• اطلبي الله ودوري لك ع زوج ","md")
end
end
...
fne = redis:get(bot_id..':toob:Name:'..zoog2)
albnt = "["..fne.."](tg://user?id="..zoog2..") "
return bot.sendText(msg_chat_id,msg_id,"• ي : "..albnt.." زوجك يبيك ","md")
else
return bot.sendText(msg_chat_id,msg_id,"• اطلب الله ودورلك ع زوجه ","md")
end
end
if text == "زواجي" then
if not redis:get(bot_id..msg_chat_id..msg.sender.user_id.."rgalll2:") and not redis:get(bot_id..msg_chat_id..msg.sender.user_id.."bnttt2:") then
return bot.sendText(msg_chat_id,msg_id,"انت اعزب","md")
end
if redis:get(bot_id..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = redis:get(bot_id..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = redis:get(bot_id..msg_chat_id..zwga_id.."rgalll2:") 
local mhrr = redis:get(bot_id..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = bot.getUser(zwga_id)
fne = redis:get(bot_id..':toob:Name:'..zwga_id)
alzog = "["..fne.."](tg://user?id="..zwga_id..") "
local albnt = bot.getUser(zoog2)
...
return bot.sendText(msg_chat_id,msg_id,"• عقد زواجكم\n• الزوج : "..alzog.."\n• الزوجه : "..albnt.." \n• المهر : "..mhrr.." ريال ","md")
end
if redis:get(bot_id..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = redis:get(bot_id..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = redis:get(bot_id..msg_chat_id..zwga_id.."bnttt2:") 
local mhrr = redis:get(bot_id..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = bot.getUser(zwga_id)
...
local yemsg = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
local ban = bot.getUser(yemsg.sender.user_id)
if ban.first_name then
news = "["..ban.first_name.."]("..ban.first_name..")"
else
news = " لا يوجد"
end
if redis:sismember(bot_id.."noooybgy",yemsg.sender.user_id) then
cccc = redis:get(bot_id.."noolb"..yemsg.sender.user_id)
gg = redis:get(bot_id.."nnonb"..yemsg.sender.user_id)
uuuu = redis:get(bot_id.."nnonbn"..yemsg.sender.user_id)
pppp = redis:get(bot_id.."zrffdcf"..yemsg.sender.user_id) or 0
ballancee = redis:get(bot_id.."nool:flotysb"..yemsg.sender.user_id) or 0
bot.sendText(msg.chat_id,msg.id, "•* ال ↢ *"..news.."\n*• الحساب ↢ *`"..cccc.."`\n*• بنك ↢ ( *"..gg.."* )\n• نوع ↢ ( *"..uuuu.."* )\n• الرصيد ↢ ( *"..ballancee.."* ريال 💸 )\n• الزرف ( *"..pppp.."* ريال 💸 )\n-*","md",true)
else
bot.sendText(msg.chat_id,msg.id, "• ماعنده  حساب بنكي لازم يرسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end

if text == "خلع" then
if not redis:get(bot_id..msg_chat_id..msg.sender.user_id.."bnttt2:") then
...
return bot.sendText(msg.chat_id,msg.id, "عشان تخلعينه لازم تجمعين "..mhrr.." ريال\n-","md",true)
end
...
redis:del(bot_id.."mznom"..msg_chat_id..zwga_id)
redis:srem(bot_id.."almtzog"..msg_chat_id,zwga_id)
redis:del(bot_id.."mznom"..msg_chat_id..msg.sender.user_id)
redis:srem(bot_id.."almtzog"..msg_chat_id,msg.sender.user_id)
redis:del(bot_id..msg_chat_id..msg.sender.user_id.."mhrrr2:")
redis:del(bot_id..msg_chat_id..zwga_id.."mhrrr2:")
redis:del(bot_id..msg_chat_id..msg.sender.user_id.."bnttt2:")
redis:del(bot_id..msg_chat_id..zwga_id.."bnttt2:")
redis:del(bot_id..msg_chat_id..msg.sender.user_id.."rgalll2:")
redis:del(bot_id..msg_chat_id..zwga_id.."rgalll2:")
bot.sendText(msg_chat_id,msg_id,"• تم خلعت زوجك "..alzog.." \n ورجعت له "..mhrr.." ريال","md")
end
if text == "طلاق"  then
if not redis:get(bot_id..msg_chat_id..msg.sender.user_id.."rgalll2:") then
...
local gg = bot.getUser(zwga_id)
alzog = " "..gg.first_name.." "
bot.sendText(msg_chat_id,msg_id,"• تم طلقتك من "..alzog.."","md")
redis:del(bot_id.."mznom"..msg_chat_id..zwga_id)
redis:srem(bot_id.."almtzog"..msg_chat_id,zwga_id)
redis:del(bot_id.."mznom"..msg_chat_id..msg.sender.user_id)
redis:srem(bot_id.."almtzog"..msg_chat_id,msg.sender.user_id)
...
bot.sendText(msg.chat_id,msg.id, "• فلوسك `"..ballancee.."` ريال 💸","md",true)
end
...
bot.sendText(msg.chat_id,msg.id, "• فلوسه *"..ballanceed.." ريال* 💸","md",true)
end
...
rr = oger(check_time)
return bot.sendText(msg.chat_id, msg.id,"• ماتكدر تضارب الآن\n• تعال بعد "..rr.." دقيقة") 
end
...
return bot.sendText(msg.chat_id,msg.id, "• الحد الادنى المسموح هو 200 ريال 💸\n-","md",true)
end
if tonumber(ballancee) < tonumber(coniss) then
...
rr = oger(check_time)
return bot.sendText(msg.chat_id, msg.id,"• ماتكدر تستثمر الآن\n• تعال بعد "..rr.." دقيقة") 
end
...
bot.sendText(msg.chat_id,msg.id, "Ok"..response.." ok","md",true)
end
...
redis:setex(bot_id.."nnooo" .. msg.sender.user_id,200, true)
...
bot.sendText(msg.chat_id,msg.id, "• للاسف خسرت بال \n• فلوسك قبل ↢ ( "..ballancee.." ريال 💸 )\n• الخساره ↢ ( "..coniss.." ريال 💸 )\n• فلوسك الآن ↢ ( "..ff.." ريال 💸 )\n-","md",true)
end
else
bot.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
...
redis:set('bot_id:'..bot_id..'idgem:user'..msg.chat_id_,taha)  
redis:setex('bot_id:'..bot_id.."gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
redis:incrby('bot_id:'..bot_id..'add:F'..msg.chat_id_..result.sender_user_id_,F)  
redis:incrby('bot_id:'..bot_id..'add:Fall'..msg.chat_id_..result.sender_user_id_,F)  
...
if redis:get(bot_id.."polici" .. msg.sender.user_id) then  
local check_time = redis:ttl(bot_id.."polici" .. msg.sender.user_id)
rr = oger(check_time)
return bot.sendText(msg.chat_id, msg.id,"• دعبل وتعال حول مرا لاخ بعد  "..rr.." دقيقة") 
end

if tonumber(coniss) < 5000 then
return bot.sendText(msg.chat_id,msg.id, "• الحد الادنى المسموح به هو 5000 ريال \n-","md",true)
end
ballancee = redis:get(bot_id.."nool:flotysb"..msg.sender.user_id) or 0
...
redis:del(bot_id.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
redis:del(bot_id.."transn" .. msg.sender.user_id)
return bot.sendText(msg.chat_id,msg.id,"• ماتكدر تحول لنفسك ","md",true)
end
...
if redis:sismember(bot_id.."noooybgy",msg.sender.user_id) then
if redis:get(bot_id.."nnoo1" .. msg.sender.user_id) then  
local check_time = redis:ttl(bot_id.."nnoo1" .. msg.sender.user_id)
rr = oger(check_time)
return bot.sendText(msg.chat_id, msg.id,"• من شوي عطيتك انتظر "..rr.." دقيقة") 
end
if redis:get(bot_id.."xxxr" .. msg.sender.user_id) then
redis:incrby(bot_id.."nool:flotysb"..msg.sender.user_id , 1000000)
redis:sadd(bot_id.."ttpppi",msg.sender.user_id)
return bot.sendText(msg.chat_id,msg.id,"• خذ قرض 1000000 ريال 💸","md",true)
end
local jjjo = "6000000"
redis:incrby(bot_id.."nool:flotysb"..msg.sender.user_id , jjjo)
redis:sadd(bot_id.."ttpppi",msg.sender.user_id)
bot.sendText(msg.chat_id,msg.id,"• خذ ي مطفر "..jjjo.." ريال 💸","md",true)
redis:setex(bot_id.."nnoo1" .. msg.sender.user_id,600, true)
else
bot.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if text == 'بقشيش' or text == 'بخشيش' then
if redis:sismember(bot_id.."noooybgy",msg.sender.user_id) then
...
redis:sadd(bot_id.."ttpppi",msg.sender.user_id)
return bot.sendText(msg.chat_id,msg.id,"• خذ بخشيش المحظوظين 3000 ريال 💸","md",true)
end
...
bot.sendText(msg_chat_id,msg_id,"تقفلت لعبة الكنز عزلنا يلا دعبل..","md",true)  
end
...
return bot.sendText(msg.chat_id,msg.id, "• ماتكدر تزرفه فلوسه اقل من 2000  ريال 💸","md",true)
end
